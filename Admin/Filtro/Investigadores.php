...
<div class="row">
  ...
  <br>
  <div class="dropdown">
  <button class="btn btn-primary dropdown" name="filtro" type="button" data-toggle="dropdown">Investigador
  <span class="caret"></span></button>
  <ul class="dropdown-menu">
    <li><a href="../Utilizadores.php">Mostrar todos</a></li>
    <li><a href="Tecnicos.php">Técnico</a></li>
  </ul>
</div>
...
<br>
  ...
  <table class="table table-hover">
	...
	$resultinv = mysqli_query ($link, "SELECT IDUtilizador, Nome, Email, Tipo FROM utilizador WHERE Tipo= 'investigador'");
